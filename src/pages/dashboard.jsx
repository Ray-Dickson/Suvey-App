...
import { getSurveys } from '../services/dummydata';
          ...
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-gray-900">
                {surveys.reduce((total, survey) => total + (survey.responses || 0), 0)}
              </p>
            </div>
          </div>
        </div>
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="mt-2 flex items-center space-x-4 text-sm text-gray-500">
                      ...
                      <span className="flex items-center">
                        ...
                        {survey.updatedAt ? formatDate(survey.updatedAt) : 'N/A'}
                      </span>
                    </div>
                  </div>
          ...
          <div className="bg-white rounded-lg shadow-xl w-full max-w-md" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="px-6 py-4">
              <p className="text-sm text-gray-600 mb-4">
                Share this link with others to collect responses for "{shareModal.survey?.title}"
              </p>
              <div className="flex items-center space-x-2">
                <input
                  type="text"
